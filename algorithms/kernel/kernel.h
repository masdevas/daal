...
#define __DAAL_INSTANTIATE_DISPATCH_CPUID(ContainerTemplate, Mode, ClassName, BaseClassName, ...)                                                    \
    ...
    {                                                                                                                                               \
        ...
        {                                                                                                                                           \
            _cntr = (new ContainerTemplate<__VA_ARGS__, sse2>(daalEnv)); break;                                                                     \
        }                                                                                                                                           \
    }                                                                                                                                               \
                                                                                                                                                    \
...
#define __DAAL_INSTANTIATE_DISPATCH_CONTAINER_CPUID(ContainerTemplate, Mode, ...) \
    __DAAL_INSTANTIATE_DISPATCH_CPUID(ContainerTemplate, Mode, AlgorithmDispatchContainer, AlgorithmContainerImpl<Mode>, __VA_ARGS__)
